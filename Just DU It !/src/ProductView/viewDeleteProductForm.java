...
public class viewDeleteProductForm extends JFrame implements ActionListener{
	...
	private void Layout() {
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				int input = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this product?", "Delete Product", JOptionPane.YES_NO_OPTION);
				if(input == 0) {
		...
		deleteProduct= new JButton("Back to Manage Product Form");
